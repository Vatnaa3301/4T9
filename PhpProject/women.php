...
$stmt = $pdo->query("SELECT * FROM women ORDER BY $orderBy");
...
<head>
    ...
    <title>Women's Collection - 4T9</title>
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <div class="product-image">
                        ...
                        <button class="quick-add" onclick="addToCart(<?php echo $product['id']; ?>, 'women')">+ Quick Add</button>
                    </div>

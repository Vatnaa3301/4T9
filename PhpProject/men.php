...
$stmt = $pdo->query("SELECT * FROM men ORDER BY $orderBy");
...
<head>
    ...
    <title>Men's Collection - 4T9</title>
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <div class="product-image">
                        ...
                        <button class="quick-add" onclick="addToCart(<?php echo $product['id']; ?>, 'men')">+ Quick Add</button>
                    </div>
